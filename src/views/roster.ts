...
const characterColors: Record<string, string> = {
  ...
  "12": "#f39c12",  // Jigglypuff (Rose/Orange)
  ...
  "34": "#d35400",  // Diddy Kong (Orange/Marron)
  "35": "#f39c12",  // Lucas (Jaune/Orange)
  "36": "#0057e7",  // Sonic (Bleu SEGA)
  "37": "#f1c40f",  // King Dedede (Jaune/Rouge Roi)
  "38": "#cddc39",  // Olimar (Vert/Beige)
  "39": "#3498db",  // Lucario (Bleu Aura)
  "40": "#95a5a6",  // R.O.B. (Gris Plastique)
  "41": "#2ecc71",  // Toon Link (Vert Cel-Shading)
  "42": "#8e44ad",  // Wolf (Violet Star Wolf)

  // --- SMASH 4 ---
  "43": "#e74c3c",  // Villager (Rouge T-shirt)
  "44": "#3498db",  // Mega Man (Bleu Bombardier)
  "45": "#00cec9",  // Wii Fit Trainer (Turquoise Santé)
  "46": "#00d2d3",  // Rosalina & Luma (Cyan Galaxie)
  "47": "#27ae60",  // Little Mac (Vert Ring)
  "48": "#3498db",  // Greninja (Bleu Eau)
  "49": "#e74c3c",  // Mii Brawler (Rouge Mii)
  "50": "#3498db",  // Mii Swordfighter (Bleu Mii)
  "51": "#f39c12",  // Mii Gunner (Orange Mii)
  "52": "#2ecc71",  // Palutena (Vert Cheveux)
  "53": "#f1c40f",  // Pac-Man (Jaune Pacman)
  "54": "#8e44ad",  // Robin (Violet Tactique)
  "55": "#e74c3c",  // Shulk (Rouge Monado)
  "56": "#2ecc71",  // Bowser Jr. (Vert Koopa Clown)
  "57": "#d35400",  // Duck Hunt (Marron Chien)
  "58": "#ecf0f1",  // Ryu (Blanc Karate)
  "59": "#1abc9c",  // Cloud (Vert Mako)
  "60": "#95a5a6",  // Corrin (Gris Dragon)
  "60e": "#c0392b", // Ken (Rouge Ken) - *Note: Ken est 60e selon l'ordre officiel*
  "61": "#2c3a47",  // Bayonetta (Noir/Violet Sorcière)

  // --- ULTIMATE ---
  "62": "#ff9f43",  // Inkling (Orange Encre)
  "63": "#8e44ad",  // Ridley (Violet Dragon)
  "64": "#d35400",  // Simon (Orange Vampire)
  "64e": "#3498db", // Richter (Bleu Belmont)
  "65": "#27ae60",  // King K. Rool (Vert Croco)
  "66": "#f1c40f",  // Isabelle (Jaune Marie)
  "67": "#c0392b",  // Incineroar (Rouge Feu)
  "68": "#e74c3c",  // Piranha Plant (Rouge Plante)
  "69": "#e74c3c",  // Joker (Rouge Metaverse)
  "70": "#8e44ad",  // Hero (Violet DQ)
  "71": "#d35400",  // Banjo & Kazooie (Marron/Jaune)
  "72": "#c0392b",  // Terry (Rouge Fatal Fury)
  "73": "#1abc9c",  // Byleth (Vert Menthe)
  "74": "#f1c40f",  // Min Min (Jaune Ramen)
  "75": "#3498db",  // Steve (Bleu Diamant)
  "76": "#2c3a47",  // Sephiroth (Noir Aile Unique)
  "77": "#e74c3c",  // Pyra / Mythra (Rouge/Vert)
  "78": "#574b90",  // Kazuya (Violet Devil)
  "79": "#c0392b",  // Sora (Rouge KH1 / Noir)
